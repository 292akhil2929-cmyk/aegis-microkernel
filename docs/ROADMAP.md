...
| 5–6 | EL0 tasks and timer scheduler | **In progress:** two EL0 contexts/stacks, SVC/data-abort recovery, GICv2 timer IRQs, complete integer exception frames, and timer-preemptive switching through the live runnable queue; remaining FP/SIMD context, IPC block/wake integration, per-task table roots, and ASIDs |
