...
| 5–6 | EL0 tasks and timer scheduler | **In progress:** context model, tested round-robin policy, GICv2, timer IRQs, and register-safe IRQ entry; remaining EL0 entry and scheduler-driven context switch |
