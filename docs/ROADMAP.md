...
| 5–6 | EL0 tasks and timer scheduler | **In progress:** two EL0 contexts/stacks, cooperative switching, SVC/data-abort recovery, GICv2 timer IRQs, complete general-purpose-register frames, and timer-preemptive A→B→A restoration; remaining runnable-queue integration, per-task table roots, and ASIDs |
