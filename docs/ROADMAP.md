...
| 3–4 | frame allocator and 4 KiB page tables | allocator property tests; translation-table dump; W^X kernel mappings |
| 5–6 | EL0 tasks and timer scheduler | two tasks preempt; saved register-state test; GIC timer trace |
